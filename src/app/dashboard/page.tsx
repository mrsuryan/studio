          ...
          <Card className="border-primary/10">
             ...
             {/* Responsive Card Content */}
              <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6 md:pb-8">
                  ...
                  {/* Example placeholder */}
                  <div className="mt-4 h-32 sm:h-40 md:h-48 lg:h-56 bg-muted rounded-md flex items-center justify-center text-muted-foreground border border-dashed text-base md:text-lg">
                      Progress Chart Area
                  </div>
             </CardContent>
          </Card>
